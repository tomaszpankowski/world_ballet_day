...
import Ballet from "./views/ballet";
...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/ballet",name:"Ballet",view:<Ballet/>},
...
const APP_LINKS = {
    messages: "http://localhost/world_ballet_day/public/message.php",
    register: "register.php",
    users: "http://localhost/world_ballet_day/public/user.php"
};
